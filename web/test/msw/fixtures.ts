...
export const ingestRunDetail: IngestRunDetail = {
  ...
  listings: [
    {
      normalized_listing_id: "nl_fix_1",
    ...
    {
      normalized_listing_id: "nl_fix_2",
      ...
      lead_grade: "good",
      lead_final_score: 78,
      lead_score_components: { deal: 40, buyBox: 38 },
      vehicle_candidate_id: "vc_fix_1",
    },
  ],
};
...
export const opportunities: OpportunityRow[] = [
  ...
  },
  {
    id: "opp_near_1",
    type: "near_miss",
    badges: ["First seen", "Near miss", "Estimated miles"],
    source: "facebook",
    region: "dallas_tx",
    sourceRunId: "sr_2",
    normalizedListingId: "opp_near_1",
    ...
    seenCount: 1,
    listingUrl: "https://www.facebook.com/marketplace/item/3/",
    estimateFlags: { mileage: true, style: false, mmr: true },
  },
];

export const opportunityDetail: OpportunityDetail = {
  ...opportunities[0]!,
