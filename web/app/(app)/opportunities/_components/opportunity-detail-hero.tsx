...
/**
 * Detail hero (redesign §1, widened NEXT_STEPS #58): full-width header —
 * title, one-liner, badges, primary actions. Contact Info now lives in the
 * two-column row below (paired with Vehicle) instead of squeezed in here,
 * so the page uses full width instead of reading as a narrow centered form.
 */
