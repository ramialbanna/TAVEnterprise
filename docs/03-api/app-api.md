...
| `region` | Exact match. Validated against the region enum (`dallas_tx`, `houston_tx`, `austin_tx`, `san_antonio_tx`, `lubbock_tx`, `oklahoma_city_ok`). Unknown value → `400 invalid_filter`. |
