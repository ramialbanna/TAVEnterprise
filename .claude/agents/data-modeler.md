...
- `supabase/schema.sql`, files under `supabase/migrations/`, and `docs/01-architecture/system-overview.md` §12.
...
5. Update `docs/01-architecture/system-overview.md` and any view that depends on the touched table.
...
- **Required indexes** stay required — do not remove indexes from `docs/01-architecture/system-overview.md` §12 without an ADR.
