...
|---|---|---|---|
| 1 | Promotion gate is not defined — "beats production" has no metric, threshold, holdout window, or segment guardrail. | R8, R9, R12 | DEC-2 confirmed; mechanics in [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §4. |
| 2 | Decision replay is incomplete — recommendation log can't reconstruct a past decision. | R2, R7, R9 | Schema in [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §1.4 + replay verified in §3. |
| 3 | Historical dataset cannot answer the full decision question — survivorship and pass-on counterfactual bias. | R3, R4 | v1/v2 scoped explicitly as bought-unit; pass-on logging begins day one ([`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §1.5). |
...
**Lands in.** [`ARCHITECTURE.md`](../../ARCHITECTURE.md) §3 (dual target), §4.2, §5; [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §1.4 (MMR provenance fields). **Status:** MITIGATED-IN-DESIGN.
...
**Lands in.** [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §1.4 + §3; [`ARCHITECTURE.md`](../../ARCHITECTURE.md) §4.3. **Status:** MITIGATED-IN-DESIGN. (Verify with AC-8 in CI.)
...
**Lands in.** [`ARCHITECTURE.md`](../../ARCHITECTURE.md) §5; punch-list #7. **Status:** OPEN (audit required).
...
**Lands in.** [`01-CHARTER.md`](01-CHARTER.md) §6; [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §1.5 (`maxbuy_evaluated_passes`). **Status:** RESIDUAL (acknowledged limitation) + MITIGATED-IN-DESIGN (logging started).
...
**Lands in.** [`01-CHARTER.md`](01-CHARTER.md) §5.2; [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §1.6 (`maxbuy_overrides`). **Status:** MITIGATED-IN-DESIGN.
...
**Lands in.** [`ARCHITECTURE.md`](../../ARCHITECTURE.md) §5; punch-list #10. **Status:** OPEN (backtest required).
...
**Lands in.** [`ARCHITECTURE.md`](../../ARCHITECTURE.md) §4.3; [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §1.4. **Status:** MITIGATED-IN-DESIGN.
...
**Lands in.** [`ARCHITECTURE.md`](../../ARCHITECTURE.md) §4.1; [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §1.7. **Status:** MITIGATED-IN-DESIGN (host choice = punch-list #11 spike).
...
**Lands in.** [`ARCHITECTURE.md`](../../ARCHITECTURE.md) §4.2; [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §1.4, §2. **Status:** OPEN (contract pin = punch-list #12).
...
**Lands in.** [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §1.6 + §2. **Status:** MITIGATED-IN-DESIGN.
...
**Lands in.** [`01-CHARTER.md`](01-CHARTER.md) §4 + DEC-3; [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §2. **Status:** MITIGATED-IN-DESIGN (pending DEC-3 confirm).
...
**Lands in.** [`ARCHITECTURE.md`](../../ARCHITECTURE.md) §6; punch-list #18. **Status:** OPEN.
...
**Lands in.** [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §2 (two-state display logic). **Status:** MITIGATED-IN-DESIGN.
...
**Lands in.** [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §2 (verdict conflict resolution). **Status:** MITIGATED-IN-DESIGN.
...
**Lands in.** [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §5; [`01-CHARTER.md`](01-CHARTER.md) DEC-4. **Status:** MITIGATED-IN-DESIGN (catalog set; owner confirms membership in DEC-4).
...
**Lands in.** [`ARCHITECTURE.md`](../../ARCHITECTURE.md) §4.4. **Status:** MITIGATED-IN-DESIGN (vendor confirmation = punch-list #14).
...
**Lands in.** [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §1.1. **Status:** MITIGATED-IN-DESIGN (capture quality verified in punch-list #6).
...
**Lands in.** [`ARCHITECTURE.md`](../../ARCHITECTURE.md) §4.4; [`TECHNICAL-SPEC.md`](../../TECHNICAL-SPEC.md) §1.4; [`01-CHARTER.md`](01-CHARTER.md) AC-7. **Status:** MITIGATED-IN-DESIGN (vendor contract review = punch-list #14).
