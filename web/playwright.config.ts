...
export default defineConfig({
  testDir: "./e2e",
  // Failure artifacts (traces/auto-screenshots) — gitignored via `/test-results`.
  // Deliberate state screenshots are written by specs to the committed
  // `e2e/__screenshots__/` path instead.
