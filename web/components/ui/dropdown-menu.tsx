...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item className={cn(menuItemBase, inset && "pl-8", className)} {...props} />
  );
}
...
function DropdownMenuRadioItem({
  ...
  return (
    <DropdownMenuPrimitive.RadioItem className={cn(menuItemBase, "pl-8", className)} {...props}>
      <span className="absolute left-2 flex size-3.5 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      className={cn(menuItemBase, "data-[state=open]:bg-accent", inset && "pl-8", className)}
      {...props}
    >
      {children}
