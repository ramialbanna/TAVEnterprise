...
**What this is / who it's for:** The ordered, must-resolve execution checklist before implementation begins. Each item closes by landing in one of the engineering docs ([`01-CHARTER.md`](01-CHARTER.md), [`ARCHITECTURE.md`](../../docs/07-buybox/ARCHITECTURE.md), [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md)) or as a small spike/audit report. Nothing in 01/02/03 ships until each item that touches it is closed. Audience: the dev (execution owner), TAV ownership (decision owner on items 1, 5, 8, 14), product (UX + governance owner on items 2, 4, 15, 16, 17, 18). Companion docs: [`00-LEADERSHIP-BRIEF.md`](00-LEADERSHIP-BRIEF.md) · [`01-CHARTER.md`](01-CHARTER.md) · [`ARCHITECTURE.md`](../../docs/07-buybox/ARCHITECTURE.md) · [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) · [`04-RISK-REGISTER.md`](04-RISK-REGISTER.md).
...
- **Lands in** — where the closed answer is written. If the answer is owner-only (e.g. a number), it lands in [`01-CHARTER.md`](01-CHARTER.md) §7 and the corresponding table in [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md).
...
7. **Item 3** (decision replay schema) is partly design (already written in [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §1.4 + §3) and partly dev (CI test that verifies AC-8 on every release).
...
| Lands in | [`01-CHARTER.md`](01-CHARTER.md) §7 DEC-1; [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §1.3 `maxbuy_policy` |
...
| Lands in | [`01-CHARTER.md`](01-CHARTER.md) §7 DEC-2; [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §4 |
...
| Definition of done | Closed for v1/v2: promotion gate documented in [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §4 and DEC-2. |
...
| Lands in | [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §1.4 + §3 |
...
| Recommended default | As specified in [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §1.4 — accept as-is. |
...
| Lands in | [`01-CHARTER.md`](01-CHARTER.md) §4 + DEC-3; [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §2 |
...
| Lands in | [`01-CHARTER.md`](01-CHARTER.md) §7 DEC-4; [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §5 |
...
The dev can start these in parallel with owner/product decisions. Each produces a report that lands in [`ARCHITECTURE.md`](../../docs/07-buybox/ARCHITECTURE.md) §5 or [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §1.1.
...
| Category | Data Audit |
| Closes risks | R17 |
| Lands in | [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §1.1 (field tags); [`ARCHITECTURE.md`](../../docs/07-buybox/ARCHITECTURE.md) §5 |
...
| Definition of done | Per-field null-rate table committed alongside this doc; field tags in [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §1.1 confirmed against the audit. |
...
| Category | Data Audit |
| Closes risks | R3 |
| Lands in | [`ARCHITECTURE.md`](../../docs/07-buybox/ARCHITECTURE.md) §5 |
...
| Definition of done | Support matrix CSV committed; minimum-N policy documented; routing rules in [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §2 use the matrix to compute `data_strength`. |
...
| Closes risks | R4 |
| Lands in | [`01-CHARTER.md`](01-CHARTER.md) §6; [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §1.5 (`maxbuy_evaluated_passes`) |
...
| Category | Data Audit |
| Closes risks | R1 |
| Lands in | [`ARCHITECTURE.md`](../../docs/07-buybox/ARCHITECTURE.md) §5; [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §1.4 (MMR fields on replay) |
...
| Closes risks | R8 |
| Lands in | [`ARCHITECTURE.md`](../../docs/07-buybox/ARCHITECTURE.md) §4.1; [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §1.7 (`maxbuy_pipeline_runs`) |
...
| Category | Architecture Spike |
| Closes risks | R9 |
| Lands in | [`ARCHITECTURE.md`](../../docs/07-buybox/ARCHITECTURE.md) §4.2; [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §2 (versioned API contract) |
...
| Definition of done | Contract document committed; `intelligence_worker_contract_version` value pinned in [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §1.4; compatibility test suite in CI; safe-persist field list confirmed against vendor terms. |
...
| Category | Architecture Spike |
| Closes risks | R7 |
| Lands in | [`ARCHITECTURE.md`](../../docs/07-buybox/ARCHITECTURE.md) §4.3; [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §1.2 + §1.4 |
...
| Lands in | [`ARCHITECTURE.md`](../../docs/07-buybox/ARCHITECTURE.md) §4.4 |
...
| Closes risks | R10 |
| Lands in | [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §1.6 (`maxbuy_overrides`) |
...
| Category | Workflow Decision |
| Closes risks | R13 |
| Lands in | [`TECHNICAL-SPEC.md`](../../docs/07-buybox/TECHNICAL-SPEC.md) §2 (two-state display logic) |
...
| Category | Workflow Decision |
| Closes risks | R12 |
| Lands in | [`ARCHITECTURE.md`](../../docs/07-buybox/ARCHITECTURE.md) §6 |
