...
3. Re-read CLAUDE.md §§2, 3, 9, and `docs/01-architecture/system-overview.md` (especially §§2, 4, 5, 6, 7, 13, 15, 20).
...
- **Schema:** new migrations additive? Indexes present per `docs/01-architecture/system-overview.md` §12? Views still serve `v_active_inbox` semantics?
...
SUGGESTED FOLLOW-UPS: <list, for docs/05-process/followups.md>
```
