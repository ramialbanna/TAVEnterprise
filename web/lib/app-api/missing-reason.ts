...
const CODE_MESSAGES: Record<string, string> = {
  ...
  parse_disabled: "Listing parse isn't enabled in this environment — enter vehicle details manually.",
  unsupported_listing_url: "That URL host isn't recognized — pick a source or use a supported marketplace link.",
  unsupported_source: "That marketplace isn't supported for parse yet — enter details manually.",
  fetch_failed: "Couldn't load the listing page — check the URL or enter details manually.",
  fetch_timeout: "Loading the listing timed out — try again or enter details manually.",
  parse_failed: "Couldn't read vehicle details from that page — enter them manually.",
